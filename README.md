...
PokemonGOのGOスナップショットをより充実させるアプローチとして建物を(キャラクターが特定の建物に触れると建物が(一時的に))キャラクターを連想させるカラーに変える試みを実践した。印象的で遊べる範囲が広がると感じた。

しかし課題は多く、PLATEAULOD2建物データの屋根の色彩などにもう少しフォーカスしたり生かすことも考えられたらよかった。
